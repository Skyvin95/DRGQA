...
def test(net, epoch):
    ...
    for batch_index, data in enumerate(test_loader):
        Haze_img_t, Dehazed_img_t, tex_t, color_t, mos_t = data
        ...
        S = net(Dehazed_img_t, tex_t, color_t)
...
def train(net, EPOCH):
    ...
    for epoch in range(EPOCH):
        for i, data in enumerate(train_loader):
            Haze_img, Dehazed_img, tex, color, mos = data
            ...
            net.train()
            mos_pred = net(Dehazed_img, tex, color)
